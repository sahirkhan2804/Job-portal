...
module.exports = [
  ...
  {
    title: "DevOps Engineer", location: "Delhi", level: "Senior Level", category: "Programming", salary: 53000,
    description: `<p>Enhance our deployment pipeline as a DevOps Engineer. This role will involve automating deployment processes, managing cloud infrastructure, and implementing best practices for security and performance. You will play a vital role in bridging the gap between development and operations.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Software Engineer", location: "Hyderabad", level: "Intermediate Level", category: "Programming", salary: 91000,
    description: `<p>Join our team as a Software Engineer to build high-quality applications that deliver exceptional user experiences. You will be responsible for designing, developing, and maintaining software solutions that meet business needs.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Network Engineer", location: "Bangalore", level: "Senior Level", category: "Networking", salary: 77000,
    description: `<p>We are looking for a Network Engineer to manage our infrastructure and ensure robust connectivity across all systems. Your expertise will help us design and implement network solutions that are secure and efficient.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Project Manager", location: "Bangalore", level: "Senior Level", category: "Management", salary: 60000,
    description: `<p>Lead projects as a Project Manager ensuring timely delivery and alignment with organizational goals. You will oversee project planning, execution, and monitoring, collaborating with various teams to ensure that all aspects of each project are delivered successfully.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Mobile App Developer", location: "Hyderabad", level: "Intermediate Level", category: "Programming", salary: 112000,
    description: `<p>Join our team as a Mobile App Developer to create engaging mobile applications for iOS and Android platforms. You will be responsible for the full app development lifecycle, from concept and design to deployment and maintenance.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Cloud Architect", location: "Hyderabad", level: "Senior Level", category: "Programming", salary: 96000,
    description: `<p>Design cloud solutions as a Cloud Architect, helping to transform our infrastructure and services. You will work closely with various teams to understand their requirements and translate them into secure, scalable, and efficient cloud-based solutions.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Technical Writer", location: "Mumbai", level: "Intermediate Level", category: "Marketing", salary: 72000,
    description: `<p>Join us as a Technical Writer to create user-friendly documentation that supports our products and services. You will work closely with engineers and product managers to gather information and produce clear, concise, and accurate documentation.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Cybersecurity Analyst", location: "Mumbai", level: "Intermediate Level", category: "Cybersecurity", salary: 62000,
    description: `<p>Protect our systems as a Cybersecurity Analyst. In this role, you will monitor security systems, analyze potential threats, and implement protective measures to safeguard our information and assets.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Business Analyst", location: "Mumbai", level: "Intermediate Level", category: "Management", salary: 68000,
    description: `<p>Join us as a Business Analyst to optimize our processes and improve overall efficiency. You will work closely with stakeholders to identify business needs and gather requirements for new projects.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Marketing Specialist", location: "Chennai", level: "Beginner Level", category: "Marketing", salary: 77000,
    description: `<p>Support our marketing efforts as a Marketing Specialist. In this role, you will assist with campaign execution, content creation, and social media management.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Data Scientist", location: "Indore", level: "Senior Level", category: "Data Science", salary: 65000,
    description: `<p>Join our innovative team as a Data Scientist, where you will analyze complex data sets to drive strategic decision-making. You will leverage your statistical and programming skills to uncover insights and develop predictive models.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "UX/UI Designer", location: "Hyderabad", level: "Intermediate Level", category: "Designing", salary: 64000,
    description: `<p>We are seeking a talented UX/UI Designer to enhance our user experience across digital platforms. You will collaborate with product managers and developers to create intuitive and engaging interfaces that meet user needs.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "DevOps Engineer", location: "Bangalore", level: "Senior Level", category: "Programming", salary: 74000,
    description: `<p>As a DevOps Engineer, you will play a crucial role in enhancing our software development and deployment processes. You will work with development and operations teams to automate workflows and improve system reliability.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Sales Manager", location: "Ujjain", level: "Senior Level", category: "Marketing", salary: 59000,
    description: `<p>Join our team as a Sales Manager, where you will lead our sales efforts to drive growth and increase market share. You will develop sales strategies, manage client relationships, and mentor your sales team.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Human Resources Specialist", location: "Delhi", level: "Intermediate Level", category: "Management", salary: 89000,
    description: `<p>As a Human Resources Specialist, you will support various HR functions, including recruitment, employee relations, and compliance. You will play a vital role in fostering a positive workplace culture.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Content Marketing Manager", location: "Mumbai", level: "Senior Level", category: "Marketing", salary: 99000,
    description: `<p>We are looking for a Content Marketing Manager to lead our content strategy and execution. In this role, you will develop compelling content that engages our audience and drives brand awareness.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Graphic Designer", location: "Chennai", level: "Intermediate Level", category: "Designing", salary: 91000,
    description: `<p>Join our creative team as a Graphic Designer, where you will be responsible for creating visually appealing graphics and layouts that enhance our brand identity.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Software Tester", location: "Chennai", level: "Intermediate Level", category: "Programming", salary: 123000,
    description: `<p>As a Software Tester, you will play a critical role in ensuring the quality and reliability of our software applications. You will design test cases, execute tests, and collaborate with development teams to identify and resolve defects.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Network Security Engineer", location: "Bangalore", level: "Senior Level", category: "Cybersecurity", salary: 87000,
    description: `<p>We are seeking a Network Security Engineer to protect our organization's IT infrastructure. You will design and implement security measures to safeguard systems from unauthorized access.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
  ...
  {
    title: "Cloud Engineer", location: "Hyderabad", level: "Intermediate Level", category: "Programming", salary: 102000,
    description: `<p>Join our technology team as a Cloud Engineer, where you will be responsible for designing and managing our cloud infrastructure. You will collaborate with development and operations teams to ensure efficient deployment and scaling.</p>
    <h2><strong>Key Responsibilities</strong></h2>
    <ol>
